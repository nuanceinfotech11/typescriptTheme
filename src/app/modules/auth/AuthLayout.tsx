  ...
  return (
    <div className='d-flex flex-column flex-lg-row flex-column-fluid h-100'>
      ...
      <div
        ...
        style={{backgroundImage: `url(${toAbsoluteUrl('/media/dashboard/login-bg.jpg')})`}}
      >
        {/* begin::Content */}
        <div className='d-flex flex-column flex-center py-15 px-5 px-md-15 w-100'>
          ...
          {/* <img
            ...
            src={toAbsoluteUrl('/media/dashboard/login-page-bg.jpg')}
            alt=''
          /> */}
          {/* end::Image */}
          ...
          {/* <h1 className='text-white fs-2qx fw-bolder text-center mb-7'>
            Fast, Efficient and Productivesss
          </h1> */}
          {/* end::Title */}
