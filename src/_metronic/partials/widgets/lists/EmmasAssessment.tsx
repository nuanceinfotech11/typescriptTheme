...
const EmmasAssessment: React.FC<Props> = ({className}) => {
  return (
    <div className={`card ${className}`}>
      {/* begin::Header */}
      <div className='card-header align-items-center border-0 mt-4'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='fw-bold mb-2 text-dark'>Emma's Assessment Journey</span>
        ...
        <div className='timeline-label'>
          ...
          <div className='timeline-item'>
            ...
            <div className='timeline-label fw-bold text-gray-800 fs-6'>
              ...
              <KTIcon iconName='setting' className='fs-2 me-3 text-success' /> Comprehensive Survey
            </div>
            {/* end::Label */}
            {/* begin::Badge */}
            ...
            {/* end::Badge */}
            {/* begin::Text */}
            <div className='fw-mormal timeline-content text-dark fw-bold ps-3'>Completed</div>
            {/* end::Text */}
          </div>
          {/* end::Item */}
          {/* begin::Item */}
