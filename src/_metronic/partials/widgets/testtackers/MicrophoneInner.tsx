...
const MicroPhoneInner  = ({className}: Props) => {
  return (
      ...
      <div className='card-body d-flex flex-column justify-content-between overflow-hidden p-10 position-relative'>
        ...
        <div className='row justify-content-between position-relative align-items-center'>
          <div className='col-lg-6'>
            <div className='bg-light-primary shadow d-flex flex-column h-100 min-h-500px justify-content-between p-10 position-relative rounded-4'>
              <div className='position-relative'>
                <h1 className='fs-2hx fw-bold mb-6 text-dark'>Microphone Test</h1>
                <p className='fs-3'>
                ...
                <ol className='inner-list fs-6 pt-5'>
                    <li>Click the “Start Mic Test” button below.</li>
                    <li>Click “Allow” when you see the pop-up in your browser.</li>
                    <li>Make some noise! You should see movement in the sound bars</li>
                </ol>
                
              </div>
              <div className='align-items-center d-flex justify-content-between'>
                   <button className='btn btn-dark fs-md-7 d-flex align-items-center'>Start Mic Test <img src={toAbsoluteUrl('/media/dashboard/microphone.png')} alt='' className='w-15px ms-2 invert' /></button> 
          ...
          <div className='col-lg-6'>
            ...
            <img src={toAbsoluteUrl('/media/dashboard/microphone-back.png')} alt='' className='border-dashed p-8 img-fluid' />
            </div>
            ...
            <div className='align-items-center d-flex justify-content-center m-0 gap-5 position-relative'>
              ...
              <Link to='/speakertest' className='btn btn-success fw-semibold px-6 py-3'>
