...
const Content = ({children}: WithChildren) => {
  ...
  return (
    <div
      id='kt_app_content'
      className={clsx(
        'align-items-center app-content d-flex flex-column flex-column-fluid h-100 justify-content-center',
    ...
    >
      {appContentContainer ? (
        <div
          ...
          className={clsx('app-container pt-0 d-flex flex-column flex-grow-1', classes.contentContainer.join(' '), {
